...
public class LightEnemy : MonoBehaviour, IEnemyInterface
{
    #region Variables
    ...
    void Move()
    {
        ...
        {
            if (traceDist.magnitude < ES.abilityValue)
            {
                // run away
    ...
    {
        yield return GameManager.Instance.AppropriateDelay;
        ProjectileManager.Instance.SetProjectileObjectActive(1, transform.position);
